...
<?php
	...
	while($valor = mysql_fetch_array($rs)){ ?>
		<tr>
			...
			<td class="item_tabela_cliente" align='center'><a href='alterar.php?cod=<?php echo $valor["cod_cliente"];?>'><img src='icones/editar.png' alt = 'edit' height='16'></a></td>
			<td class="item_tabela_cliente" align='center'><a href='deletar.php?cod=<?php echo $valor["cod_cliente"];?>'><img src='icones/deletar.png' alt = 'delet' height='16'></a></td>
		</tr>
		<?php
	}
