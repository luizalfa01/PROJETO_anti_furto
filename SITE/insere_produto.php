<?php
	...
	if($con){
		$sql = "insert into produto (descricao, nome_produto, preco, foto, estoque, cod_fornecedor)".
			"values('$descricao_produto', '$nome_produto', '$preco_produto', '$imagem', '$estoque_produto', '$fornecedor')";
