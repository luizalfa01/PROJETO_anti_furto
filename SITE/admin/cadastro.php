...
?>
	...
	<center><h1>CADASTRO ADMINISTRADOR</h1></center><br>
	...
	<table class="tabela_cadastro" width="50%" height="450px">
		...
		<tr><td>Nome: </td><td><input type="text" name="nome_admin" size=40 maxlength=80 class="caixa"></td></tr>
		<tr><td>Sexo: </td><td><input type="radio" name="sexo_admin" value = "M"
		...
		<tr><td>Endereço: </td><td><input type="text" name="end_admin" size=40 maxlength=80 class="caixa"></td></tr>
