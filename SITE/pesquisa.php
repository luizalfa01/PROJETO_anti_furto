...
?>
	...
	$sql = "select * from produto WHERE (nome_produto LIKE '%$procurar%' or descricao LIKE '%$procurar%');";
	...
	<table class="tabela_cliente" width = 80%>
		...
		<tr>
			<td class="item_tabela_cliente"><img src='admin/imagens_produtos/<?php echo $valor["foto"]==null?"nouser.png":$valor["foto"];?>' alt="X" width="100" height="80"></td>
